export class Preflight {
    ...
    constructor(settings) {
        ...
        this.settings.zoom = (this.settings.smallScreen) ? 3 : 5 ;

        this.settings.pixelWidth = self.pixelWidth(this.settings.screenWidth)
    ...
    screenTest() {
        ...
        return (window.innerWidth < 540) ? true : false ;
